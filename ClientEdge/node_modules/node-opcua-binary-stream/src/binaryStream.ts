 ...
 * @param {Number} value
 */
BinaryStream.prototype.writeInt8 = function (value: number) {
 ...
 * @param {Number} value
 */
BinaryStream.prototype.writeUInt8 = function (value: number) {
 ...
 * @param {Number} value
 */
BinaryStream.prototype.writeInt16 = function (value: number) {
 ...
 * @param {Number} value
 */
BinaryStream.prototype.writeUInt16 = function (value: number) {
 ...
 * @param {Number} value
 */
BinaryStream.prototype.writeInteger = function (value:number) {
 ...
 * @param {Number} value
 */
BinaryStream.prototype.writeUInt32 = function (value: number) {
 ...
 * @param {Number} value
 */
BinaryStream.prototype.writeFloat = function (value: number) {
 ...
 * @param value
 */
BinaryStream.prototype.writeDouble = function (value: number) {
...
function display_memcpy_missing_message() {
    ...
    console.warn(chalk.yellow("             you can install it memcpy using this command ( extra c++ compilation tools may be required on your system)"));
    console.warn(chalk.yellow("              $ npm install  memcpy"));
    console.warn("");
}
...
try {
    ...
    my_memcpy = memcpy;
    console.log(chalk.yellow("Warning : using memcpy : OK"));
}
catch (err) {
 ...
 */
BinaryStream.prototype.writeByteStream = function (buf: Buffer) {
